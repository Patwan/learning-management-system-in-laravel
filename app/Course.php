...
class Course extends Model
{
    ...
    //This method ensures that each teacher sees only courses that h/she created and not of any other teacher. But admin can view all courses created by all teachers

    //Note: Methods writen in the model can be used anywhere within the view or controller related to this model
