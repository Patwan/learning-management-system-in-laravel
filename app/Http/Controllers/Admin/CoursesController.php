...
class CoursesController extends Controller
{
    ...
    public function index()
    {
        ...
        //Responsible for delete/Trash button in courses view
    ...
    public function create()
    {
        ...
        //Will check if the user has a role of teachers only and will get the name and id from the database table
    ...
    public function store(StoreCoursesRequest $request)
    {
        ...
        //Ternary operator. If the user who created a course is an admin an array of teachers who creatred a course will be displayed in the view otherwise the user will be displayed 
