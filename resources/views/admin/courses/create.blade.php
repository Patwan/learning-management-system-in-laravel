...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <!--This field is dispalyed conditionally. If the user has a role of Admin it will be displayed  if not an admin it wont be displayed. isAdmin is a method found in the User method which checks if the User is an admin. Hence this field will be displayed if Authenticated user is an Admin.-->
            <!-- This is because Admin and teachers have permission to create courses hence we can display some fields conditionally according to role.-->
